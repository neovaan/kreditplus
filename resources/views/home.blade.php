...
<section class="slidehome">
    <div class="boxsliderhome">
        <div class="list-slide">
            <figure>
                <img src="images/content/slidehome-01.jpg" img-large="images/content/slidehome-01.jpg" img-medium="images/content/slidehome-01-md.jpg" img-small="images/content/slidehome-01-sm.jpg" alt="slidehome 1">
            </figure>
            <div class="desc">
                <div class="wrapper">
                    <i class="dotted"></i>
                    <h1>pembiayaan kredit yang mudah, cepat, aman</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</p>
                    <a href="pengajuan.php" class="btn-box btn-red">AJUKAN KREDIT</a>
                </div>
            </div>
        </div>
        <div class="list-slide white">
            <figure>
                <img src="images/content/slidehome-02.jpg" img-large="images/content/slidehome-02.jpg" img-medium="images/content/slidehome-01-md.jpg" img-small="images/content/slidehome-01-sm.jpg" alt="slidehome 2">
            </figure>
            <div class="desc">
                <div class="wrapper">
                    <i class="dotted"></i>
    ...
    <div class="wrapper">
        <div class="box-servicehome">
                ...
                <div class="box-simservice">
                    <div class="list-simservice a-from-bottom" delay=".9" trigger-anim=".trig-service">
                        <a href="kantor_cabang.php">
                            <figure><img src="images/content/ic_office.png" alt="kantor cabang"></figure>
                            <span>Kantor Cabang</span>
                        </a>
                    </div>
                    <div class="list-simservice a-from-bottom" delay="1" trigger-anim=".trig-service">
                        <a href="simulasi.php">
                            <figure><img src="images/content/ic_simulation.png" alt="simulasi kredit"></figure>
                    ...
                    <div class="list-simservice a-from-bottom" delay="1.1" trigger-anim=".trig-service">
                        <a href="tel:02129333646">
                            <figure><img src="images/content/ic_phone.png" alt="telepon hotline"></figure>
            ...
            <div class="right-service">
                <div class="mcycle"><img src="images/content/motorcycle-img.png" alt="motorcycle"></div>
                <div class="scar"><img src="images/content/car-img.png" alt="car"></div>
                <div class="dots"></div>
...
<section class="produkkredit">
    ...
    <div class="inprodukkredit a-from-bottom" delay=".3" trigger-anim=".trig-produk" style="background-image: url('images/content/bg-kredibilitas.jpg');">
            ...
            <div class="circwhite">
                <div class="box-list-product">
                    <div class="list-product">
                        <a href="produk_elektronik.php">
                            <div class="in-product">
                                <figure><img src="images/content/prod-01.jpg" alt="Pembelian Elektronik"></figure>
                                <div class="desc">
                    ...
                    <div class="list-product">
                        <a href="produk_mobil.php">
                            <div class="in-product">
                                <figure><img src="images/content/prod-02.jpg" alt="Pembelian Mobil"></figure>
                                <div class="desc">
                    ...
                    <div class="list-product">
                        <a href="produk_motor.php">
                            <div class="in-product">
                                <figure><img src="images/content/prod-03.jpg" alt="Pembelian Motor"></figure>
                                <div class="desc">
                    ...
                    <div class="list-product">
                        <a href="produk_pinjaman.php">
                            <div class="in-product">
                                <figure><img src="images/content/prod-04.jpg" alt="Peminjaman Modal Usaha"></figure>
                                <div class="desc">
        ...
        <div class="box-infohome">
            <div class="lg-info a-from-left" delay=".5" trigger-anim=".trig-info">
                <a href="information_promo_detail.php">
                    <figure>
                        <img src="images/content/news-lg-01.jpg" alt="promo">
            ...
            <div class="sm-info">
                <div class="box-list-info-sm">
                    <div class="list-info-sm a-from-right" delay=".8" trigger-anim=".trig-info">
                        <a href="information_promo_detail.php">
                            <figure>
                                <img src="images/content/news-thumb-01.jpg" alt="berita">
                    ...
                    <div class="list-info-sm a-from-right" delay=".9" trigger-anim=".trig-info">
                        <a href="information_promo_detail.php">
                            <figure>
                                <img src="images/content/news-thumb-02.jpg" alt="promo">
                                <span class="lbl">PROMO</span>
                            </figure>
                            <div class="desc-sm-info">
...
<section class="testimonihome">
    ...
    <div class="intestimonihome a-from-bottom" delay=".3" trigger-anim=".trig-testimoni" style="background-image: url('images/content/bg-testimoni.jpg');">
        <div class="wrapper">
            ...
            <div class="box-list-testimoni">
                <div class="list-testimoni">
                    <div class="inner-testimoni">
                        <div class="img-testi">
                            <figure><img src="images/content/user-01.jpg" alt="testimoni"></figure>
                            <div class="ttl-testi">
                                <h6>Jane Doe</h6>
                ...
                <div class="list-testimoni">
                    <div class="inner-testimoni">
                        <div class="img-testi">
                            <figure><img src="images/content/user-02.jpg" alt="testimoni"></figure>
                            <div class="ttl-testi">
                                <h6>Felicia</h6>
                                <span>Karyawan swasta</span>
                            </div>
    ...
    <div class="wrapper">
        <div class="box-list-sponsor">
            <div class="list-sponsor">
                <a href=""><img src="images/content/spons-elevania.png" alt="elevania"></a>
            </div>
            <div class="list-sponsor">
                <a href=""><img src="images/content/spons-home.png" alt="home"></a>
            </div>
            <div class="list-sponsor">
                <a href=""><img src="images/content/spons-jdid.png" alt="jdid"></a>
            </div>
            <div class="list-sponsor">
                <a href=""><img src="images/content/spons-target.png" alt="target"></a>
            </div>
            <div class="list-sponsor">
                <a href=""><img src="images/content/spons-elevania.png" alt="elevania"></a>
            </div>
