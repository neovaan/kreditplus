...
<section class="banner">
	<figure>
		<img src="{{URL('images/content/banner-pinjaman.jpg')}}" alt="banner">
	</figure>
...
<section class="ctnwp">
	<div class="wrap-sm">
		<h3 class="tblue">PINJAMAN USAHA</h3>
		<h3 class="tregular">Kreditplus memberikan solusi kebutuhan pengadaan barang modal dan bahan baku dengan proses yang mudah, cepat dan aman.</h3>
		...
		<ol>
			...
			<li>Jaminan BPKB “Mobil & Motor”</li>
			<li>Pembayaran angsuran yang mudah melalui berbagai payment point</li>
		</ol>
		
		<br>

		Berikut adalah persyaratan aplikasi pengajuan pinjaman usaha:
		<br>
		<br>
		<table >
			<thead>
		...
		<div class="related-product">
			...
			<div class="prod-list-h">
				...
				<div class="list-prod">
					<a href="">
						<figure><img src="{{URL('images/content/prod-03.jpg')}}" alt="product 3"></figure>
						<div class="desc-prod">
