...
<section class="banner">
	<figure>
		<img src="{{URL('images/content/banner-promo.jpg')}}" alt="banner">
	</figure>
	...
	<div class="wrap-sm">
		...
		<div class="promo-list">
			<div class="list-promo">
				<figure><img src="{{URL('images/content/promo-01.jpg')}}" alt="promo 1"></figure>
			...
			<div class="list-promo">
				<figure><img src="{{URL('images/content/promo-02.jpg')}}" alt="promo 2"></figure>
				<div class="desc-promo">
