...
<section class="banner">
	<figure>
		<img src="images/content/banner-about.jpg" alt="banner">
	</figure>
		...
		<div class="wrap-sm">
			<div class="box-submenu">
				...
				<div class="drop-submenu">
					<ul>
						<li class="active"><a href="about_profile.php">Profile</a></li>
						<li><a href="about_visimisi.php">Visi & Misi</a></li>
						<li><a href="about_management.php">Manajemen</a></li>
						<li><a href="about_prestasi.php">Prestasi Perusahaan</a></li>
						<li><a href="about_gcg.php">GCG</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="ctnwp">
	<div class="wrap-sm">
		...
		<div class="imgctn">
			<div class="left">
				<img src="images/content/office-01.jpg" alt="office 1">
			</div>
			<div class="right">
				<img src="images/content/office-02.jpg" alt="office 2">
			</div>
		</div>
