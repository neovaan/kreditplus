...
<section class="banner">
	<figure>
		<img src="images/content/banner-produk.jpg" alt="banner">
	</figure>
		...
		<div class="wrap-sm">
			<div class="box-submenu">
				...
				<div class="drop-submenu">
					<ul>
						<li class="active"><a href="produk_elektronik.php">Elektronik</a></li>
						<li><a href="produk_mobil.php">Mobil</a></li>
						<li><a href="produk_motor.php">Motor</a></li>
						<li><a href="produk_pinjaman.php">Modal Usaha</a></li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="wrap-sm">
		...
		<div class="related-product">
			...
			<div class="prod-list-h">
				<div class="list-prod">
					<a href="">
						<figure><img src="images/content/prod-02.jpg" alt="product 1"></figure>
						<div class="desc-prod">
				...
				<div class="list-prod">
					<a href="">
						<figure><img src="images/content/prod-03.jpg" alt="product 2"></figure>
						<div class="desc-prod">
				...
				<div class="list-prod">
					<a href="">
						<figure><img src="images/content/prod-04.jpg" alt="product 3"></figure>
						<div class="desc-prod">
