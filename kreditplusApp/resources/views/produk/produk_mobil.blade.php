...
<section class="banner">
	<figure>
		<img src="{{URL('images/content/banner-mobil.jpg')}}" alt="banner">
	</figure>
...
<section class="ctnwp">
	<div class="wrap-sm">
		<h3 class="tblue">PEMBELIAN MOBIL</h3>
		<h3 class="tregular">Kreditplus membantu konsumen mewujudkan impian untuk memiliki mobil impian  dengan harga yang terjangkau.</h3>

		Solusi pembiayaan kendaraan mobil & motor anda dengan proses yang mudah, cepat dan aman.
		...
		Berikut adalah persyaratan aplikasi pengajuan kredit mobil:
		<br>
		<br>
		<table >
			<thead>
